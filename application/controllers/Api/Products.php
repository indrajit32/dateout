...
class Products extends REST_Controller
{
     ...
     * Ex:  http://localhost/dateout/api/productbycategory/bg/3/get
     */

    public function categorywiseproduct_get($lang,$category_id)
    {
        $products = $this->Api_model->getProductsByCategory($lang,$category_id);
