...
<script>
    var urls = {
        ...
        removeSecondaryExpectationsImage: '<?= base_url('admin/removeSecondaryExpectationsImage') ?>',
        ...
        uploadExpectationImages: '<?= base_url('admin/uploadExpectationImages') ?>',
        loadExpectationsImages: '<?= base_url('admin/loadExpectationsImages') ?>',
