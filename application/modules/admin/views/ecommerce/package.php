...
<h1><img src="<?= base_url('assets/imgs/shop-cart-add-icon.png') ?>" class="header-img" style="margin-top:-3px;"> Package</h1>
<hr>
<?php
$timeNow = time();
...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <button type="submit" name="submit" class="btn btn-lg btn-default btn-package">Publish</button>
